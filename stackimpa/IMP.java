/*
 * Program that takes a jpg image, and gives pixel location and color, and then
 * changes the rest of the pixels of that color to black, until it hits a pixel
 * of another color using a heap. My contribution is the Pixel class and then the fun2()
 * method, which includes the heap and changing of pixel colors. 
 */
package stackimpa;
...
class IMP implements MouseListener{
  ...
  private void fun2()
  {
      Stack<Pixel> st = new Stack<Pixel>();
      Pixel np = new Pixel(colorY, colorX);
      int [] rgbA = getPixelArray(picture[colorY][colorX]);
      np.setColor(rgbA);
      st.push(np);
      while(!st.empty()) {
          Pixel topP = st.peek();
          switch(topP.count) {
              case 1:
                  Pixel temp = new Pixel(topP.getY() - 1, topP.getX() - 1);
                  int [] rgb1 = getPixelArray(picture[topP.getY() - 1][topP.getX() - 1]);
                  temp.setColor(rgb1);
                  if (temp.redC() == np.redC() && temp.greenC() == np.greenC() && temp.blueC() == np.blueC()) {
                      temp.setBlack();
                      picture[topP.getY() - 1][topP.getX() - 1] = getPixels(temp.getColor());
                      st.push(temp);
                      topP.count++;
                      break;
                      //temp.redC() == np.redC() && temp.greenC() == np.greenC() && temp.blueC() == np.blueC()
                  } else {
                      topP.count++;
                      break;
                  }
              case 2:
                  Pixel temp2 = new Pixel(topP.getY() - 1, topP.getX());
                  int [] rgb2 = getPixelArray(picture[topP.getY() - 1][topP.getX()]);
                  temp2.setColor(rgb2);
                  if (temp2.redC() == np.redC() && temp2.greenC() == np.greenC() && temp2.blueC() == np.blueC()) {
                      temp2.setBlack();
                      picture[topP.getY() - 1][topP.getX()] = getPixels(temp2.getColor());
                      st.push(temp2);
                      topP.count++;
                      break;
                  } else {
                      topP.count++;
                      break;
                      //temp2.redC() == np.redC() && temp2.greenC() == np.greenC() && temp2.blueC() == np.blueC()
                  }
              case 3:
                  Pixel temp3 = new Pixel(topP.getY() - 1, topP.getX() + 1);
                  int [] rgb3 = getPixelArray(picture[topP.getY() - 1][topP.getX() + 1]);
                  temp3.setColor(rgb3);
                  if (temp3.redC() == np.redC() && temp3.greenC() == np.greenC() && temp3.blueC() == np.blueC()) {
                      temp3.setBlack();
                      picture[topP.getY() - 1][topP.getX() + 1] = getPixels(temp3.getColor());
                      st.push(temp3);
                      topP.count++;
                      break;
                  } else {
              ...
              case 4:
                  Pixel temp4 = new Pixel(topP.getY(), topP.getX() + 1);
                  int [] rgb4 = getPixelArray(picture[topP.getY()][topP.getX() + 1]);
                  temp4.setColor(rgb4);
                  if (temp4.redC() == np.redC() && temp4.greenC() == np.greenC() && temp4.blueC() == np.blueC()) {
                      temp4.setBlack();
                      picture[topP.getY()][topP.getX() + 1] = getPixels(temp4.getColor());
                      st.push(temp4);
                      topP.count++;
                      break;
                  } else {
              ...
              case 5:
                  Pixel temp5 = new Pixel(topP.getY() + 1, topP.getX() + 1);
                  int [] rgb5 = getPixelArray(picture[topP.getY() + 1][topP.getX() + 1]);
                  if (temp5.redC() == np.redC() && temp5.greenC() == np.greenC() && temp5.blueC() == np.blueC()) {
                      temp5.setBlack();
                      picture[topP.getY() + 1][topP.getX() + 1] = getPixels(temp5.getColor());
                      st.push(temp5);
                      topP.count++;
                      break;
                  } else {
              ...
              case 6:
                  Pixel temp6 = new Pixel(topP.getY() + 1, topP.getX());
                  int [] rgb6 = getPixelArray(picture[topP.getY() + 1][topP.getX()]);
                  if (temp6.redC() == np.redC() && temp6.greenC() == np.greenC() && temp6.blueC() == np.blueC()) {
                      temp6.setBlack();
                      picture[topP.getY() + 1][topP.getX()] = getPixels(temp6.getColor());
                      st.push(temp6);
                      topP.count++;
                      break;
                  } else {
              ...
              case 7:
                  Pixel temp7 = new Pixel(topP.getY() + 1, topP.getX() - 1);
                  int [] rgb7 = getPixelArray(picture[topP.getY() + 1][topP.getX() - 1]);
                  if (temp7.redC() == np.redC() && temp7.greenC() == np.greenC() && temp7.blueC() == np.blueC()) {
                      temp7.setBlack();
                      picture[topP.getY() + 1][topP.getX() - 1] = getPixels(temp7.getColor());
                      st.push(temp7);
                      topP.count++;
                      break;
                  } else {
              ...
              case 8:
                  Pixel temp8 = new Pixel(topP.getY(), topP.getX() - 1);
                  int [] rgb8 = getPixelArray(picture[topP.getY()][topP.getX() - 1]);
                  if (temp8.redC() == np.redC() && temp8.greenC() == np.greenC() && temp8.blueC() == np.blueC()) {
                      temp8.setBlack();
                      picture[topP.getY()][topP.getX() - 1] = getPixels(temp8.getColor());
                      st.push(temp8);
                      topP.count++;
                      break;
                  } else {
